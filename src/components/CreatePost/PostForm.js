...
<div className='containerPostForm'>
      ...
      <div className='PostForm'>
        <div className='contenPostForm'>
          ...
          <form className='formDescription'>
            <div className='secUno'>
              <div >
                ...
                <input onChange={name=>onInputChange(name)} name="namePatient" type="text" placeholder="Escribe aquí"/>
              </div>
              <div>
                <p>Edad del Paciente</p>
                <input onChange={age=>onInputChange(age)} type="number" id="edad" name="agePatient" placeholder="De click en las flechas o Escribe"/>
              </div>
            </div>
            <div className='secUno'>
              <div >
                <p>Telefono del Contacto</p>
                <input  onChange={contact_phone=>onInputChange(contact_phone)} type="tel"  name="contact_phone" />
              </div>
              <div>
              <p>Dirección del paciente</p>
                <input  onChange={addressPatient=>onInputChange(addressPatient)} type="text"  name="addressPatient" />
              </div> 
              <div>
                <p>Referencia Locacion </p>
                <textarea onChange={rl=>onInputChange(rl)} id="msg" name="locationReference" placeholder="Escribe aquí"></textarea>
              </div>
            </div>
            <div className='secUno'>
              <div>
            ...
            <div className='secUno'>
              <div>
               <p>Especialidades Necesitadas</p>
                ...
                onChange={specialtyPatient=>onInputChange(specialtyPatient)} 
                ...
                placeholder="Escribe aquí o selecciona uno"/>
                  <datalist id="Especialidades">
                    ...
                    <option value="Acompañante de Adulto Mayor">Acompañante de Adulto Mayor</option>
            ...
            <div className='secUno'>
              <div>
                ...
                <textarea onChange={need=>onInputChange(need)} id="msg" name="needs" placeholder="Escribe aquí"></textarea>
              </div>
              <div>
          ...
          <button className='buttonOne buttonNavTwo' onClick={() => cancelar()}>Cancelar</button>
          <input className='buttonOne' type="submit"  onClick={onSubmit} value="Crear"/>
          </div>
        </div>
      </div>
      <div className='Colum1'></div>
